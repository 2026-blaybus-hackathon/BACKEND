...
enum class ErrorCode(
    ...
    FORBIDDEN_FOR_CREATE_FEEDBACK(HttpStatus.FORBIDDEN, -14000, "해당 할 일에 피드백을 작성할 수 없습니다."),
    FORBIDDEN_FOR_CREATE_FEEDBACK_SUMMARY(HttpStatus.FORBIDDEN, -14000, "해당 할 일에 피드백 요약본을 작성할 수 없습니다."),
}
