...
(
    ...
    mentee_id              NUMBER(38, 0)                                  NOT NULL,
    start_date             date                                           NOT NULL,
    end_date               date                                           NOT NULL,
    overall_review         CLOB                                           NOT NULL,
    keep_content           VARCHAR2(255),
    problem_content        VARCHAR2(255),
    try_content            VARCHAR2(255),
    total_study_minutes INTEGER NOT NULL,
    total_achievement_rate INTEGER                                        NOT NULL,
...
ALTER TABLE report_subject
    ADD CONSTRAINT FK_REPORT_SUBJECT_ON_REPORT FOREIGN KEY (report_id) REFERENCES report (id);
...
(
    id                NUMBER(38, 0) GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    created_datetime  TIMESTAMP                                      NOT NULL,
    recipient_id      NUMBER(38, 0)                                  NOT NULL,
    type              VARCHAR2(30)                                   NOT NULL,
    task_id           NUMBER(38, 0),
    planner_date      date,
    report_period     VARCHAR2(10),
    report_start_date date,
    is_read           NUMBER(1) DEFAULT 0                            NOT NULL,
    CONSTRAINT pk_notifications PRIMARY KEY (id)
);

CREATE INDEX idx_notifications_created_datetime ON notifications (created_datetime);
